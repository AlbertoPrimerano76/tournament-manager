...
import { Globe, Pencil, Plus, X, Building2, Trash2, Link as LinkIcon, MapPin, MapPinned } from 'lucide-react'
      ...
      <div className="mb-6 flex flex-col gap-4 rounded-[2rem] border border-white/80 bg-white/80 p-6 shadow-[0_35px_90px_-60px_rgba(15,23,42,0.45)] backdrop-blur md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
            Configura branding, link pubblici, colori e accesso alle pagine dedicate di ogni società.
          </p>
        </div>
        <button
          onClick={openCreate}
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-1 flex flex-wrap gap-3 text-xs text-gray-400">
            ...
            {/* Color swatches */}
            <span className="flex items-center gap-1">
              <span className="w-3 h-3 rounded-full inline-block border border-white shadow-sm" style={{ backgroundColor: o.primary_color }} />
              <span className="w-3 h-3 rounded-full inline-block border border-white shadow-sm" style={{ backgroundColor: o.accent_color }} />
            </span>
          </div>
        </div>
